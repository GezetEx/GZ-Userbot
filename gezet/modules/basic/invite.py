...
async def inviteee(client: Client, message: Message):
    ...
    if not user_s_to_add:
        await mg.edit("`Beri Saya Pengguna Untuk Ditambahkan! Periksa Menu Bantuan Untuk Informasi Lebih Lanjuto!`")
        return
    ...
    try:
        ...
        return
    await mg.edit(f"`berhasil ditambahkan {len(user_list)} To This Group / Channel!`")

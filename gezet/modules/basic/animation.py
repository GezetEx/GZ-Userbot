...
from gezet.helper.basic import edit_or_reply, get_text
from gezet.helper.constants import MEMES
...
async def gagahkah(client: Client, message: Message):
    ...
    animation_chars = [
        ...
        "What The F",
        "What The F Brah",
        "[𝗪𝗵𝗮𝘁 𝗧𝗵𝗲 𝗙 𝗕𝗿𝗮𝗵](https://telegra.ph//file/1e2162b7d856a76d8e45d.jpg)",
    ]
    for i in animation_ttl:
...
async def kocok(client: Client, message: Message):
    ...
    await e.edit("8===✊D💦💦💦💦💦💦💦💦💦")
    await e.edit("8==✊=D💦💦💦💦💦💦💦💦💦💦")
    await e.edit("8=✊==D Itu sebabnya ini sudah berakhir?")
    await e.edit("RIP 😭😭😭😭")

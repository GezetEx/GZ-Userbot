...
async def uptotelegraph(client: Client, message: Message):
    ...
    if message.reply_to_message.media:
        ...
        try:
            ...
            return
        U_done = (
            f"**Diunggah pada ** [Telegraph](https://telegra.ph/{media_url[0]})"
        )
        ...
        try:
            ...
            await tex.edit(f"**ERROR:** `{exc}`")
            return
        wow_graph = f"**Diunggah sebagai** [Telegraph](https://telegra.ph/{response['path']})"

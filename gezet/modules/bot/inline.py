...
from gezet import CMD_HELP, StartTime, app
from gezet.helper.data import Data
from gezet.helper.inline import inline_wrapper, paginate_help
...
async def help_function(answers):
    ...
    answers.append(
        InlineQueryResultArticle(
            ...
            thumb_url="https://graph.org/file/2c0dce6b40c329569f8d0.jpg",
            input_message_content=InputTextMessageContent(

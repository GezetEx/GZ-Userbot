from gezet.database import cli
import asyncio

collection = cli["gezet"]["pmpermit"]

PMPERMIT_MESSAGE = (
    "**ᴡᴀʀɴɪɴɢ! ᴘʟᴇᴀꜱᴇ ʀᴇᴀᴅ ᴛʜɪꜱ ᴍᴇꜱꜱᴀɢᴇ ᴄᴀʀᴇꜰᴜʟʟʏ..\n\n**"
    "**ɪᴍ ɢᴇᴢᴇᴛ ᴜꜱᴇʀʙᴏᴛ ʜᴇʀᴇ ᴛᴏ ᴘʀᴏᴛᴇᴄᴛ ᴍʏ ᴍᴀꜱᴛᴇʀ ꜰʀᴏᴍ ꜱᴘᴀᴍᴍᴇʀꜱ..**"
    "**ɪꜰ ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ꜱᴘᴀᴍᴍᴇʀ ᴛʜᴇɴ ᴘʟᴇᴀꜱᴇ ᴡᴀɪᴛ!!.\n\n**"
    "**ᴜɴᴛɪʟ ᴛʜᴇɴ, ᴅᴏɴᴛ ꜱᴘᴀᴍ,ᴏʀ ʏᴏᴜʟʟ ɢᴇᴛ ʙʟᴏᴄᴋᴇᴅ ᴀɴᴅ ʀᴇᴘᴏʀᴛᴇᴅ ʙʏ ᴍᴇ,ꜱᴏ ʙᴇ ᴄᴀʀᴇꜰᴜʟʟ ᴛᴏ ꜱᴇɴᴅ ᴀɴᴏ ᴍᴇꜱꜱᴀɢᴇ!!**"
)
